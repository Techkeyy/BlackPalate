...
async function runAudit() {
  ...
  test('Zero-Emoji: System prompt explicitly commands zero emoji output', () => {
    const samplePrompt = 'No emoji. Never include emoji characters in generated titles, descriptions, or questions.';
    assert.strictEqual(samplePrompt.includes('No emoji'), true);
  });
